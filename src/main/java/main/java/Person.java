...
public class Person {
    ...
    private List<main.java.Pet> pets;
    ...
    public List<main.java.Pet> getPets() {
        return pets;
    }
    ...
    public void addChild(Person parent, Person child) {
        ...
        if(parent.getChildren()!= null){
            for(Person c = (Person) parent.getChildren();;) children.add(child);
    ...
    public void addSiblings(Person parent, Person child) {
        ...
        if (parent.getSiblings() != null){
            for (Person c = (Person) parent.getSiblings();;) siblings.add((Person) siblings);

        } else {
            siblings.add((Person) siblings);
        }
